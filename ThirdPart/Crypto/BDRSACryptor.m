                                                   ...
                                                   error:(BDError *)error
{
    ...
    NSDictionary *publicKeyDict = [self X509FormattedPublicKey:publicKeyIdentifier error:error];
    
    BDRSACryptorKeyPair *result = [[BDRSACryptorKeyPair alloc] initWithPublicKey:[publicKeyDict objectForKey:@"publicKey"]
                                                                 remotePublicKey:nil
                                                                 exportPublicKey:[publicKeyDict objectForKey:@"exportPublicKey"]
                                                                    privateKey:[self PEMFormattedPrivateKey:privateKeyIdentifier error:error]];
...
//    NSString *result = [encodedKey base64Encoding];
    
    return result;
}


- (NSDictionary *)X509FormattedPublicKey:(NSString *)tag error:(BDError *)error {
...
//    NSString *exportString = [encodedKey base64Encoding];
    ...
    return [NSDictionary dictionaryWithObjectsAndKeys:
            ...
            exportString, @"exportPublicKey", nil];
}
